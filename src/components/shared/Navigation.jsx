...
export default function Navigation() {
  ...
  return (
    <nav className="glass-nav sticky top-0 z-50">
      <div className="container mx-auto px-0 sm:px-0.5 md:px-1 lg:px-2 py-2 sm:py-3 md:py-4 max-w-[100%]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 pr-1 sm:pr-2 md:pr-3">
            <Link 
              to="/profile" 
